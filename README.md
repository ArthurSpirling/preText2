...
```
This seems close enough to me, and I *believe* what differences remain---especially on removing infrequent terms---are a product of some `quanteda` changes in terms of how it tokenizes (partly documented [here](https://quanteda.io/news/news-3.3.html#changes-and-additions-3-3-0).
